  ...
  const sections: CuriositySection[] = [
    {
      ...
      content: (
        <div className="space-y-6">
          <h2 className="text-3xl font-bold text-blue-600 mb-4">Santos da Igreja</h2>
          
          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">São Francisco de Assis</h3>
            ...
            <p className="text-sm text-blue-600 font-medium">Festa: 4 de outubro</p>
          </div>

          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Santa Teresinha do Menino Jesus</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <p className="text-sm text-blue-600 font-medium">Festa: 1º de outubro</p>
          </div>

          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">São Padre Pio</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <p className="text-sm text-blue-600 font-medium">Festa: 23 de setembro</p>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <h2 className="text-3xl font-bold text-blue-600 mb-4">Beato Carlo Acutis</h2>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-blue-800">O Jovem Santo da Internet</h3>
                <p className="text-blue-600">1991 - 2006</p>
              </div>
            </div>
          </div>

          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Vida e Vocação</h3>
          ...
          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Características Especiais</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <h2 className="text-3xl font-bold text-blue-600 mb-4">Milagres Eucarísticos</h2>
          
          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Milagre de Lanciano (Século VIII)</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <p className="text-sm text-blue-600 font-medium">Local: Lanciano, Itália</p>
          </div>

          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Milagre de Bolsena (1263)</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <p className="text-sm text-blue-600 font-medium">Local: Bolsena, Itália</p>
          </div>

          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Milagre de Buenos Aires (1996)</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <p className="text-sm text-blue-600 font-medium">Local: Buenos Aires, Argentina</p>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <h2 className="text-3xl font-bold text-blue-600 mb-4">Curiosidades da Igreja Católica</h2>
          
          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">O Vaticano</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">A Capela Sistina</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Os Papas</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <div className="bg-white rounded-lg p-6 shadow-md">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Língua Oficial</h3>
            <p className="text-gray-700 leading-relaxed mb-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-4 sticky top-8">
              <h3 className="text-lg font-semibold text-blue-800 mb-4">Navegação</h3>
